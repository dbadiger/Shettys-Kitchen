    ...
    return (
        <form className='place-order' onSubmit={placeOrder}>
            <div className="place-order-left">
                ...
                <input required name="email" onChange={onChnageHandler} value = {data.email} type="text" placeholder='Email Address' />
                ...
                <input required name="phone" onChange={onChnageHandler} value = {data.phone}  type="text" placeholder='Contact Number' />
            </div>
